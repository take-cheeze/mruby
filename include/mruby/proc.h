...
MRB_API struct RProc *mrb_proc_new_cfunc_with_env(mrb_state *mrb, mrb_func_t func, mrb_int argc,
...
#define MRB_METHOD_CFUNC_P(m)  \
  (MRB_METHOD_FUNC_P(m) ? TRUE \
                        : (MRB_METHOD_PROC(m) ? (MRB_PROC_CFUNC_P(MRB_METHOD_PROC(m))) : FALSE))
#define MRB_METHOD_CFUNC(m)                                                             \
  (MRB_METHOD_FUNC_P(m) ? MRB_METHOD_FUNC(m)                                            \
