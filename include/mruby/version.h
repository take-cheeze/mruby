...
#define MRUBY_VERSION                \
  ...
  "." MRB_STRINGIZE(MRUBY_RELEASE_MINOR) "." MRB_STRINGIZE(MRUBY_RELEASE_TEENY)
...
#define MRUBY_RELEASE_DATE \
  MRUBY_RELEASE_YEAR_STR "-" MRUBY_RELEASE_MONTH_STR "-" MRUBY_RELEASE_DAY_STR
 ...
 */
#define MRUBY_DESCRIPTION "mruby " MRUBY_VERSION " (" MRUBY_RELEASE_DATE ")"

/*
 * mruby's copyright information.
 */
#define MRUBY_COPYRIGHT                                                       \
  "mruby - Copyright (c) " MRB_STRINGIZE(MRUBY_BIRTH_YEAR) "-" MRB_STRINGIZE( \
      MRUBY_RELEASE_YEAR) " " MRUBY_AUTHOR
