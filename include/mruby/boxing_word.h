...
#define BOXWORD_SHIFT_VALUE(o, n, t) (t)(((long)(o).w) >> BOXWORD_##n##_SHIFT)
...
#define BOXWORD_OBJ_TYPE_P(o, n)    (!mrb_immediate_p(o) && (o).value.bp->tt == MRB_TT_##n)
...
typedef union mrb_value {
  union {
    ...
    struct {
      MRB_ENDIAN_LOHI(mrb_sym sym;, uint32_t sym_flag;)
    };
#endif
    struct RBasic *bp;
#ifndef MRB_WITHOUT_FLOAT
...
mrb_type(mrb_value o)
{
  return !mrb_bool(o) ? MRB_TT_FALSE
                      : mrb_true_p(o) ? MRB_TT_TRUE
                                      : mrb_fixnum_p(o)
              ? MRB_TT_FIXNUM
              : mrb_symbol_p(o) ? MRB_TT_SYMBOL : mrb_undef_p(o) ? MRB_TT_UNDEF : o.value.bp->tt;
}
