...
MRB_API mrb_value mrb_obj_iv_get(mrb_state *mrb, RObject *obj, mrb_sym sym);
MRB_API void mrb_obj_iv_set(mrb_state *mrb, RObject *obj, mrb_sym sym, mrb_value v);
MRB_API mrb_bool mrb_obj_iv_defined(mrb_state *mrb, RObject *obj, mrb_sym sym);
...
MRB_API void mrb_mod_cv_set(mrb_state *mrb, RClass * c, mrb_sym sym, mrb_value v);
