...
int32_t mrb_debug_get_break_all(mrb_state *, mrb_debug_context *, uint32_t,
...
int32_t mrb_debug_check_breakpoint_method(mrb_state *, mrb_debug_context *, struct RClass *,
                                          mrb_sym, mrb_bool *);
